      ...
      <div className="z-10 w-full md:w-auto">
        ...
        <div
          className="flex pt-5 flex-col md:flex-row w-full
                  child:border child:border-white child:p-3 child:w-64 hover:child:bg-white hover:child:text-black child:transition-colors child:cursor-pointer child:mx-auto md:child:mx-0"
        >
