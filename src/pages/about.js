export default function Home() {
  return (
    <div className="w-full flex justify-center py-5 pt-16">
      ...
      >
        <div>
          <h1 className="text-7xl md:text-8xl font-bold pb-2">ABOUT LAION</h1>
          <p className="text-lg">
        ...
        <div className="">
          <p className="text-7xl md:text-8xl font-bold pb-2">OUR BELIEF</p>
          <p className="text-lg">
        ...
        <div>
          <p className="text-7xl md:text-8xl font-bold pb-2">FUNDING</p>
          <p className="text-lg">
