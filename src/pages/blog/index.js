  ...
  return (
    <div className="w-full flex justify-center pt-16 md:pt-5">
      ...
      <div className="container px-5">
        ...
        <div class="text-md pb-4">Welcome to our LAION blog! Here, you will find commentaries, news, and updates on current research projects and progress in the field of AI research. These blog posts are not meant to be full scientific research papers, but work in progress to encourage further reserach / discussions on our discord server and the open scientific community.</div>
